...
#define CLOCK_SOURCE                                      USE_PLL_HSE_XTAL|USE_PLL_HSI // set by target:DISCO_F769NI
...
#define MBED_CONF_LWIP_SOCKET_MAX                         10                           // set by library:lwip
...
#define MBED_CONF_LWIP_TCP_SERVER_MAX                     10                           // set by library:lwip
#define MBED_CONF_LWIP_TCP_SOCKET_MAX                     10                           // set by library:lwip
#define MBED_CONF_LWIP_UDP_SOCKET_MAX                     10                           // set by library:lwip
#define MBED_CONF_LWIP_USE_MBED_TRACE                     0                            // set by library:lwip
#define MBED_CONF_NSAPI_PRESENT                           1                            // set by library:nsapi
#define MBED_CONF_PLATFORM_DEFAULT_SERIAL_BAUD_RATE       921600                       // set by library:platform
#define MBED_CONF_PLATFORM_FORCE_NON_COPYABLE_ERROR       0                            // set by library:platform
#define MBED_CONF_PLATFORM_STDIO_BAUD_RATE                921600                       // set by library:platform
...
#define MBED_CONF_TARGET_LOWPOWERTIMER_LPTIM              1                            // set by target:DISCO_F769NI
...
//#define MBED_CONF_LWIP_PBUF_POOL_SIZE 123
#endif
