...
void dip_D0()  { out_D0  = false; __NOP(); out_D0  = true; }
void dip_D1()  { out_D1  = false; __NOP(); out_D1  = true; }
void dip_D2()  { out_D2  = false; __NOP(); out_D2  = true; }
void dip_D3()  { out_D3  = false; __NOP(); out_D3  = true; }
void dip_D4()  { out_D4  = false; __NOP(); out_D4  = true; }
void dip_D5()  { out_D5  = false; __NOP(); out_D5  = true; }
void dip_D6()  { out_D6  = false; __NOP(); out_D6  = true; }
void dip_D7()  { out_D7  = false; __NOP(); out_D7  = true; }
void dip_D8()  { out_D8  = false; __NOP(); out_D8  = true; }
void dip_D9()  { out_D9  = false; __NOP(); out_D9  = true; }
void dip_D10() { out_D10 = false; __NOP(); out_D10 = true; }
void dip_D11() { out_D11 = false; __NOP(); out_D11 = true; }
void dip_D12() { out_D12 = false; __NOP(); out_D12 = true; }
void dip_D13() { out_D13 = false; __NOP(); out_D13 = true; }

void write_u32(const uint32_t v) { saleae.printf("0x%08X", v); }
}
